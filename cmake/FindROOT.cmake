...
#  REMOVE_FROM_LIST(root_flags "${root_libs_all}" "${root_library}")
  ...
  IF (found_root_major_vers EQUAL 5)
      FIND_PROGRAM(ROOT_DICT_EXECUTABLE
        NAMES rootcint
        PATHS ${ROOT_BINARY_DIR}
        NO_DEFAULT_PATH
        )
   ENDIF (found_root_major_vers EQUAL 5)
   ...
   IF (NOT ROOT_DICT_EXECUTABLE)
    message(FATAL "root dictionary executable not found")
   endif (NOT ROOT_DICT_EXECUTABLE)
   
   message(STATUS "root dict generator: " ${ROOT_DICT_EXECUTABLE})
...
#  MESSAGE("BLA: ${bla}")
  ...
  if (CMAKE_SYSTEM_NAME MATCHES Linux)
    ADD_CUSTOM_COMMAND(OUTPUT ${OUTFILES}
       COMMAND LD_LIBRARY_PATH=${ROOT_LIBRARY_DIR} ROOTSYS=${ROOTSYS} ${ROOT_DICT_EXECUTABLE}
       ARGS -f ${OUTFILE} -c -DHAVE_CONFIG_H ${INCLUDE_DIRS} ${INFILES} ${LINKDEF_FILE} DEPENDS ${INFILES} ${LINKDEF_FILE})
  else (CMAKE_SYSTEM_NAME MATCHES Linux)
    if (CMAKE_SYSTEM_NAME MATCHES Darwin)
      ADD_CUSTOM_COMMAND(OUTPUT ${OUTFILES}
       COMMAND DYLD_LIBRARY_PATH=${ROOT_LIBRARY_DIR} ROOTSYS=${ROOTSYS} ${ROOT_DICT_EXECUTABLE}
       ARGS -f ${OUTFILE} -c -DHAVE_CONFIG_H ${INCLUDE_DIRS} ${INFILES} ${LINKDEF_FILE} DEPENDS ${INFILES} ${LINKDEF_FILE})
