...
int main()
{
    ...
    {
        std::cout<<" * system is x86-64"<<std::endl;
    }
    if (EIGEN_ARCH_i386)
    {
        std::cout<<" * system is i386"<<std::endl;
    }
    if (EIGEN_COMP_GNUC)
    {
        std::cout<<" * compiler is gcc-compatible"<<std::endl;
    }
    if (EIGEN_COMP_GNUC_STRICT)
    {
        std::cout<<" * compiler is strict-gcc"<<std::endl;
    }
    if (EIGEN_COMP_CLANG)
    {
